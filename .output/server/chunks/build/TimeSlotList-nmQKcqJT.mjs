...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const store = useBookingStore();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="text-[12.5px] tracking-[0.03em] text-gray font-semibold mb-2.5">${ssrInterpolate(unref(store).fullDateLabel.toUpperCase())} \xB7 AVAILABLE TIMES </div><!--[-->`);
...
//# sourceMappingURL=TimeSlotList-nmQKcqJT.mjs.map
