...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-RvDxndOv.mjs')
  },
  {
    name: "book-food",
    path: "/book/food",
    component: () => import('./food-BlHr4aKj.mjs')
  },
  {
    name: "book-court",
    path: "/book/court",
    component: () => import('./court-C8X0tttS.mjs')
  },
  {
    name: "book",
    path: "/book",
    component: () => import('./index-CfNwnoP1.mjs')
  },
  {
    name: "book-paddles",
    path: "/book/paddles",
    component: () => import('./paddles-oF3OSOZ3.mjs')
  },
  {
    name: "book-payment",
    path: "/book/payment",
    component: () => import('./payment-Bc15JMP0.mjs')
  },
  {
    name: "book-summary",
    path: "/book/summary",
    component: () => import('./summary-DsOYxwPI.mjs')
  },
  {
    name: "book-confirmed-bookingId",
    path: "/book/confirmed/:bookingId()",
    component: () => import('./_bookingId_-BQyr5WTI.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-u_JNiGqb.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-irkX0kSU.mjs'));
...
export { __nuxt_component_0$1 as _, useRoute as a, defineStore as d, entry_default as default, navigateTo as n, useHead as u };
