...
const _routes = [
  ...
  },
  {
    name: "book-court",
    path: "/book/court",
    component: () => import('./court-msCFhxbM.mjs')
  },
  {
    name: "book",
    path: "/book",
    component: () => import('./index-l1zNyQSJ.mjs')
  },
  {
    name: "book-details",
    path: "/book/details",
  ...
  },
  {
    name: "book-paddles",
    path: "/book/paddles",
    component: () => import('./paddles-fC8MV6B5.mjs')
  },
  {
    name: "book-payment",
    path: "/book/payment",
    component: () => import('./payment-C96Ps-hy.mjs')
  },
  {
    name: "book-summary",
    path: "/book/summary",
    component: () => import('./summary-DacqgJoT.mjs')
  },
  {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DQfIEDG1.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BqqiK8fw.mjs'));
