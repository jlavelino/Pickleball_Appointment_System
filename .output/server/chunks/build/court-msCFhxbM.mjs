...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderComponent, ssrRenderClass, ssrRenderStyle, ssrIncludeBooleanAttr } from 'vue/server-renderer';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.hours && __props.hours > 1) {
        _push(`<span class="font-semibold text-[var(--ink)]" data-v-49997c57> \xB7 \u20B1${ssrInterpolate(__props.court.price * __props.hours)} total (${ssrInterpolate(__props.hours)} hrs) </span>`);
      } else {
        _push(`<!---->`);
      }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const continueButtonLabel = computed(() => {
      ...
      if (count === 1) return `Continue (1 court \xB7 \u20B1${store.courtTotal})`;
      return `Continue (${count} courts \xB7 \u20B1${store.courtTotal})`;
    });
...
//# sourceMappingURL=court-msCFhxbM.mjs.map
