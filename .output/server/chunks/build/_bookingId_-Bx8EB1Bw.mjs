...
import { u as useHead, d as useRoute, b as useBookingStore, n as navigateTo } from './server.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        ...
        "court-name": unref(store).courtNamesLabel || ((_a = unref(store).selectedCourt) == null ? void 0 : _a.name) || "Court 1",
...
//# sourceMappingURL=_bookingId_-Bx8EB1Bw.mjs.map
