    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(store).paddleCount > 0) {
        ...
        if (mainPaddleLine.value.sub) {
          _push(`<span>${ssrInterpolate(mainPaddleLine.value.sub)} · </span>`);
        } else {
          _push(`<!---->`);
        }
...
//# sourceMappingURL=summary-DacqgJoT.js.map
